...
const config = {
  ...
  projectName: 'Realmverse', // Usually your repo name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/BibliothecaForAdventurers/documentation',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `${new Date().getFullYear()} Realms, Inc. Built with Docusaurus.`,
      },
      prism: {
